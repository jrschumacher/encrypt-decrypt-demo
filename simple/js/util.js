...
function getEndpointsByEnvironment(){
  ...
  const envs = {
    ...
    "staging": {
      ...
      "proxyEndpoint": "https://apps.staging.virtru.com/test-zack/proxy.html",
      "sdkUrlBase":  "https://sdk-develop01.develop.virtru.com/js/latest/virtru-sdk.min.js"
    },
    "production": {
      "stage": "production",
      ...
      "proxyEndpoint": "https://apps.virtru.com/test-zack/proxy.html",
...
function chooseAuthProviderByType(opts){
  ...
  switch(type){
    ...
    case 'email-static':
      return Virtru.Auth.Providers.EmailCodeAuthProvider;
    case 'static':
